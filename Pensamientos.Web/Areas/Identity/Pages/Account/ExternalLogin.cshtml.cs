...
namespace Pensamientos.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.Roles.Facebook))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.Roles.Facebook));
                    }

                    if (string.IsNullOrEmpty(Input.Rol))
                    {
                        await _userManager.AddToRoleAsync(user, SD.Roles.Facebook);
                    }
